...
#define PIN_PUSHBUTTON_0    {AT91C_PIO_PB27, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEGLITCH | PIO_PULLUP}
// Push button #1 definition.
#define PIN_PUSHBUTTON_1    {AT91C_PIO_PB4, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEGLITCH | PIO_PULLUP}
// Push button #2 definition
#define PIN_PUSHBUTTON_2    {AT91C_PIO_PA29, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_DEGLITCH | PIO_PULLUP}
// Push button #3 definition.
#define PIN_PUSHBUTTON_3    {AT91C_PIO_PB15, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEGLITCH | PIO_PULLUP}
