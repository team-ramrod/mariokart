...
#define PIN_CHAR_DISPLAY_A {AT91C_PIO_PB0, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
// Char Display B pin definition.
#define PIN_CHAR_DISPLAY_B {AT91C_PIO_PB1, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
// Char Display C pin definition.
#define PIN_CHAR_DISPLAY_C {AT91C_PIO_PB2, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
// Char Display D pin definition.
#define PIN_CHAR_DISPLAY_D {AT91C_PIO_PB3, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
// List of all LEDs pin definitions.
#define PINS_CHAR_DISPLAY PIN_CHAR_DISPLAY_A, PIN_CHAR_DISPLAY_B, PIN_CHAR_DISPLAY_C, PIN_CHAR_DISPLAY_D
...
#define PIN_CHAR_DISPLAY_SELECT_L {AT91C_PIO_PB7, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
// Char Display Select Right pin definition.
#define PIN_CHAR_DISPLAY_SELECT_R {AT91C_PIO_PB17, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}
