...
#define TARGET_CURRENT 580 //(2.5+0.625*(140)/150)/5*1024 // 140A

#define MAX_CURRENT 600 //(2.5+0.625*(300)/150)/5*1024  // 300A

#define BRAKING_CURRENT 469 // //-50A

s32 MAX_AMP_SECONDS = 0.1e5;//(3800*(100)*0.625/150)/5*1024;
