...
\author{
  ...
  {\tt hvj10@uclive.ac.nz (83238549)}\vspace{0.1cm}\\
  {Wim Looman}\vspace{0.1cm}\\
  {\tt wgl18@uclive.ac.nz (92692734)}\vspace{0.1cm}\\
  {Simon Richards}\vspace{0.1cm}\\
  {\tt scr52@uclive.ac.nz (83238549)}\vspace{0.1cm}\\
  ...
  {\tt andrew.bainbridge-smith@canterbury.ac.nz}\vspace{0.1cm}\\
